...
{
    public partial class FinishedProductsExchangeInSearch : Form
    {
        public FinishedProductsExchangeInSearch()
        {
            InitializeComponent();
        ...
        private void SearchDataBind(int pageIndex, string whereCondition)
        {
            ...
            DataSet ds = Sdl_FinishedProductsExchangeInTitleAdapter.GetSdl_FinishedProductsExchangeInTitlePageData(pageIndex.ToString(), pager.PageSize, whereCondition);
        ...
        private void ViewDetail(string truckNum, string timeFlag, string oanum)
        {
            ...
            FinishedProductsExchangeInSearchDetail proDetail = new FinishedProductsExchangeInSearchDetail();
        ...
        {
            string Title = "史丹利产成品换货重车入厂查询";
            DataSet ds = Sdl_FinishedProductsExchangeInTitleAdapter.GetSdl_FinishedProductsExchangeInTitleDataSet(GetWhereStr());

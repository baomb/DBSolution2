...
{
    public partial class RawMaterialReturnSearch : Form
    {
        public RawMaterialReturnSearch()
        {
            InitializeComponent();
        ...
        private string GetWhereStr()
        {
            ...
            {
                condition += " and (WeighMan like '%" + textWeighMan.Text + "%' or ExitWeighMan like '%" + textWeighMan.Text + "%')";
            }
        ...
        {
            DataTable dt = Sdl_RawMaterialReturnTitleAdapter.GetSdl_RawMaterialReturnTitleSet(condition).Tables[0];
        ...
        private void ViewDetail(string truckNum, string timeFlag)
        {
            ...
            RawMaterialReturnDetail proDetail = new RawMaterialReturnDetail();
        ...
        private void btnOutExcel_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = Sdl_RawMaterialReturnTitleAdapter.GetSdl_RawMaterialReturnTitleSet(GetWhereStr());
            DataTable dt = new DataTable();
            dt.Columns.Add("工厂");
            dt.Columns.Add("车牌号");
            dt.Columns.Add("采购退货单");
            dt.Columns.Add("供应商账号");
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                dr["采购退货单"] = ds.Tables[0].Rows[i]["EBELN"].ToString();
                dr["供应商账号"] = ds.Tables[0].Rows[i]["LIFNR"].ToString();
                dr["供应商名称"] = ds.Tables[0].Rows[i]["NAME1"].ToString();

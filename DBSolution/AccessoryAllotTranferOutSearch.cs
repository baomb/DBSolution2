...
{
    public partial class AccessoryAllotTranferOutSearch : Form
    {
        public AccessoryAllotTranferOutSearch()
        {
            InitializeComponent();
        ...
        {
            DataTable dt = Sdl_AccessoryAllotOutTitleAdapter.GetSdl_AccessoryAllotOutTitleSet(condition).Tables[0];
            dataGridViewRawReturn.AutoGenerateColumns = false;
        ...
        private void ViewDetail(string truckNum, string timeFlag)
        {
            ...
            AccessoryAllotTranferOutDetail proDetail = new AccessoryAllotTranferOutDetail();
        ...
        private void btnOutExcel_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = Sdl_AccessoryAllotOutTitleAdapter.GetSdl_AccessoryAllotOutTitleSet(GetWhereStr());

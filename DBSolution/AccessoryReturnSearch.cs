...
{
    public partial class AccessoryReturnSearch : Form
    {
        public AccessoryReturnSearch()
        {
            InitializeComponent();
        ...
        {
            DataTable dt = Sdl_AccessoryReturnTitleAdapter.GetSdl_AccessoryReturnTitleSet(condition).Tables[0];
        ...
        private void ViewDetail(string truckNum, string timeFlag)
        {
            ...
            AccessoryReturnDetail proDetail = new AccessoryReturnDetail();
        ...
        private void btnOutExcel_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = Sdl_AccessoryReturnTitleAdapter.GetSdl_AccessoryReturnTitleSet(GetWhereStr());

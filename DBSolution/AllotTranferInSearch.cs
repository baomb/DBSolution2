...
{
    public partial class AllotTranferInSearch : Form
    {
        public AllotTranferInSearch()
        {
            InitializeComponent();
        ...
        private void ViewDetail(string truckNum, string timeFlag)
        {
            ...
            AllotTranferInDetail proDetail = new AllotTranferInDetail();
        ...
        private void btnOutExcel_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = Sdl_AllotInTitleAdapter.GetSdl_AllotInTitleSet(GetWhereStr());

...
{
    public partial class ProductReturnMerchantSearch : Form
    {
        public ProductReturnMerchantSearch()
        {
            InitializeComponent();
        ...
        private void ViewDetail(string truckNum, string timeFlag)
        {
            ...
            ProductReturnMerchantDetail proDetail = new ProductReturnMerchantDetail();
        ...
        private void btnOutExcel_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = Sdl_ProductReturnMerchantAdapter.GetSdl_ProductReturnMerchantSet(GetWhereStr());

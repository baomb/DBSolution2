...
{
    public partial class ProductReturnRailwayEdit : Form
    {
        Sdl_ProductReturnRailway model;
        DataTable dtfps;
        bool isInsert = false;
        public ProductReturnRailwayEdit()
        {
            InitializeComponent();
        ...
        private bool InsertData()
        {
            ...
            try
            {
                Sdl_ProductReturnRailway modelTitleInsert = new Sdl_ProductReturnRailway();
                Sdl_ProductReturnRailwayDetail modelInsert = new Sdl_ProductReturnRailwayDetail();
                ...
                for (int i = 0; i < this.dataGridViewDetail.Rows.Count - 1; i++)
                {
                    if (this.dataGridViewDetail.Rows[i].Cells["LGORT"].Value.ToString() != "" && this.dataGridViewDetail.Rows[i].Cells["POSNR"].Value.ToString() != "" && this.dataGridViewDetail.Rows[i].Cells["VBELN"].Value.ToString() != "")
                    {
                        ...
                        modelInsert.REALZFIMG = Convert.ToDouble(this.dataGridViewDetail.Rows[i].Cells["REALZFIMG"].Value);
                        ...
                        modelInsert.ZFIMG = Convert.ToDouble(this.dataGridViewDetail.Rows[i].Cells["ZFIMG"].Value);
                        modelInsert.SFIMG = Convert.ToDouble(this.dataGridViewDetail.Rows[i].Cells["SFIMG"].Value);
                        modelInsert.KUIJIAN = Convert.ToDouble(this.dataGridViewDetail.Rows[i].Cells["KUIJIAN"].Value);

                        Sdl_ProductReturnRailwayDetailAdapter.AddSdl_ProductReturnRailwayDetail(modelInsert);

                        CompareModelHelper.SdlDB_Modules module = CompareModelHelper.SdlDB_Modules.ProductReturnRailwayDetail;
                        CompareModelHelper.CompareModel(new Sdl_ProductReturnRailwayDetail(), modelInsert, CompareModelHelper.EditType.Insert, Common.GetEnumDescription(module));
                    }
                    //else
                    //{
                ...
                for (int i = 0; i < this.dataGridViewDetail.Rows.Count - 1; i++)
                {
                    modelTitleInsert = new Sdl_ProductReturnRailway();
                    ...
                    Sdl_ProductReturnRailwayAdapter.AddSdl_ProductReturnRailway(modelTitleInsert);

                    CompareModelHelper.SdlDB_Modules module = CompareModelHelper.SdlDB_Modules.ProductReturnRailway;
                    CompareModelHelper.CompareModel(new Sdl_ProductReturnRailway(), modelTitleInsert, CompareModelHelper.EditType.Insert, Common.GetEnumDescription(module));
                }
            }
            catch
            {
        ...
        private bool UpdateTitle()
        {
            ...
            try
            {
                DataTable dt = Sdl_ProductReturnRailwayAdapter.GetSdl_ProductReturnRailwayDataTable(model.TRUCKNUM, model.TIMEFLAG);
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    Sdl_ProductReturnRailway fpstNew = Sdl_ProductReturnRailwayAdapter.GetSdl_ProductReturnRailway(model.TRUCKNUM, dt.Rows[i]["VBELN"].ToString(), model.TIMEFLAG);
                    ...
                    Sdl_ProductReturnRailwayAdapter.UpdateSdl_ProductReturnRailway(fpstNew, dt.Rows[i]["VBELN"].ToString(), model.TRUCKNUM);
        ...
        private bool UpdateItem(int rowIndex)
        {
            ...
            try
            {
                Sdl_ProductReturnRailwayDetail fps = Sdl_ProductReturnRailwayDetailAdapter.GetSdl_ProductReturnRailwayDetail(model.TIMEFLAG, dtfps.Rows[rowIndex]["VBELN"].ToString(), dtfps.Rows[rowIndex]["POSNR"].ToString(), dtfps.Rows[rowIndex]["LGORT"].ToString());
                Sdl_ProductReturnRailwayDetail fpsOld = Sdl_ProductReturnRailwayDetailAdapter.GetSdl_ProductReturnRailwayDetail(model.TIMEFLAG, dtfps.Rows[rowIndex]["VBELN"].ToString(), dtfps.Rows[rowIndex]["POSNR"].ToString(), dtfps.Rows[rowIndex]["LGORT"].ToString());
                ...
                fps.KUIJIAN = Convert.ToDouble(this.dataGridViewDetail.Rows[rowIndex].Cells["KUIJIAN"].Value.ToString());

                Sdl_ProductReturnRailwayDetailAdapter.UpdateSdl_ProductReturnRailwayDetail(fps, dtfps.Rows[rowIndex]["VBELN"].ToString(), dtfps.Rows[rowIndex]["LGORT"].ToString(), dtfps.Rows[rowIndex]["POSNR"].ToString());

                CompareModelHelper.SdlDB_Modules module = CompareModelHelper.SdlDB_Modules.ProductReturnRailwayDetail;
                CompareModelHelper.CompareModel(fpsOld, fps, CompareModelHelper.EditType.Update, Common.GetEnumDescription(module));

                if (fps.VBELN != dtfps.Rows[rowIndex]["VBELN"].ToString() && !Sdl_ProductReturnRailwayAdapter.ExistsSdl_ProductReturnRailway(fps.TIMEFLAG, fps.VBELN))
                {
                    Sdl_ProductReturnRailway newTitle = Sdl_ProductReturnRailwayAdapter.GetSdl_ProductReturnRailway(model.TRUCKNUM, model.VBELN, model.TIMEFLAG);
                    newTitle.VBELN = fps.VBELN;

                    Sdl_ProductReturnRailwayAdapter.AddSdl_ProductReturnRailway(newTitle);

                    module = CompareModelHelper.SdlDB_Modules.ProductReturnRailway;
                    CompareModelHelper.CompareModel(new Sdl_ProductReturnRailway(), newTitle, CompareModelHelper.EditType.Insert, Common.GetEnumDescription(module));
                }
            }
            catch
            {
        ...
        private bool InsertItem(int rowIndex)
        {
            ...
            try
            {
                Sdl_ProductReturnRailwayDetail fps = new Sdl_ProductReturnRailwayDetail();
                fps.LFIMG = Convert.ToDouble(this.dataGridViewDetail.Rows[rowIndex].Cells["LFIMG"].Value);
                fps.LGORT = this.dataGridViewDetail.Rows[rowIndex].Cells["LGORT"].Value.ToString();
                fps.MAKTX = this.dataGridViewDetail.Rows[rowIndex].Cells["MAKTX"].Value.ToString();
                fps.MATNR = this.dataGridViewDetail.Rows[rowIndex].Cells["MATNR"].Value.ToString();
                fps.POSNR = this.dataGridViewDetail.Rows[rowIndex].Cells["POSNR"].Value.ToString();
                fps.REALZFIMG = Convert.ToDouble(this.dataGridViewDetail.Rows[rowIndex].Cells["REALZFIMG"].Value);
                fps.VBELN = this.dataGridViewDetail.Rows[rowIndex].Cells["VBELN"].Value.ToString().TrimStart('0');
                fps.ZFIMG = Convert.ToDouble(this.dataGridViewDetail.Rows[rowIndex].Cells["ZFIMG"].Value);
                fps.TIMEFLAG = model.TIMEFLAG;
                fps.SFIMG = Convert.ToDouble(this.dataGridViewDetail.Rows[rowIndex].Cells["SFIMG"].Value);
                fps.KUIJIAN = Convert.ToDouble(this.dataGridViewDetail.Rows[rowIndex].Cells["KUIJIAN"].Value);

                Sdl_ProductReturnRailwayDetailAdapter.AddSdl_ProductReturnRailwayDetail(fps);

                CompareModelHelper.SdlDB_Modules module = CompareModelHelper.SdlDB_Modules.ProductReturnRailwayDetail;
                CompareModelHelper.CompareModel(new Sdl_ProductReturnRailwayDetail(), fps, CompareModelHelper.EditType.Insert, Common.GetEnumDescription(module));

                if (!Sdl_ProductReturnRailwayAdapter.ExistsSdl_ProductReturnRailway(fps.TIMEFLAG, fps.VBELN) && fps.VBELN != model.VBELN)
                {
                    Sdl_ProductReturnRailway fpst = Sdl_ProductReturnRailwayAdapter.GetSdl_ProductReturnRailway(model.TRUCKNUM, model.TIMEFLAG);
                    fpst.VBELN = fps.VBELN;

                    Sdl_ProductReturnRailwayAdapter.AddSdl_ProductReturnRailway(fpst);

                    module = CompareModelHelper.SdlDB_Modules.ProductReturnRailway;
                    CompareModelHelper.CompareModel(new Sdl_ProductReturnRailway(), fpst, CompareModelHelper.EditType.Insert, Common.GetEnumDescription(module));
                }
            }
            catch (Exception)
            {
        ...
        private bool DeleteItem(int rowIndex)
        {
            ...
            try
            {
                Sdl_ProductReturnRailwayDetail fps = Sdl_ProductReturnRailwayDetailAdapter.GetSdl_ProductReturnRailwayDetail(model.TIMEFLAG, this.dataGridViewDetail.Rows[rowIndex].Cells["VBELN"].Value.ToString(), this.dataGridViewDetail.Rows[rowIndex].Cells["POSNR"].Value.ToString(), this.dataGridViewDetail.Rows[rowIndex].Cells["LGORT"].Value.ToString());

                Sdl_ProductReturnRailwayDetailAdapter.DeleteSdl_ProductReturnRailwayDetail(model.TIMEFLAG, this.dataGridViewDetail.Rows[rowIndex].Cells["VBELN"].Value.ToString(), this.dataGridViewDetail.Rows[rowIndex].Cells["LGORT"].Value.ToString(), this.dataGridViewDetail.Rows[rowIndex].Cells["POSNR"].Value.ToString());
        ...
        private bool DeleteTitle()
        {
            ...
            try
            {
                ...
                Sdl_ProductReturnRailwayDetailAdapter.DeleteSdl_ProductReturnRailwayDetail(model.TIMEFLAG, model.VBELN);
            }
            catch
            {
                result = false;
        ...
        private void BindData()
        {
            ...
            DataTable dt = Sdl_ProductReturnRailwayDetailAdapter.GetSdl_ProductReturnRailwayDetailSearchSet(where).Tables[0];
        ...
        public void ShowDialog(IWin32Window parent, string truckNum, string timeFlag)
        {
            if (truckNum != "" || timeFlag != "")
            {
                ...
                model = Sdl_ProductReturnRailwayAdapter.GetSdl_ProductReturnRailway(truckNum, timeFlag);
                BindData();
            }
            else
            {

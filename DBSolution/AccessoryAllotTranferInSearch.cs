...
{
    public partial class AccessoryAllotTranferInSearch : Form
    {
        public AccessoryAllotTranferInSearch()
        {
            InitializeComponent();
        ...
        {
            DataTable dt = Sdl_AccessoryAllotInTitleAdapter.GetSdl_AccessoryAllotInTitleSet(condition).Tables[0];
            dataGridViewRawReturn.AutoGenerateColumns = false;
        ...
        private void ViewDetail(string truckNum, string timeFlag)
        {
            ...
            AccessoryAllotTranferInDetail proDetail = new AccessoryAllotTranferInDetail();
        ...
        private void btnOutExcel_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = Sdl_AccessoryAllotInTitleAdapter.GetSdl_AccessoryAllotInTitleSet(GetWhereStr());

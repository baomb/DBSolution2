...
namespace SdlDB.Data.SqlServer
{
    public partial class DataProvider : IDataProvider
    {
        ...
        public DataSet GetSdl_AllotTitleSet(string where)
        {
            string sql = "select * from Sdl_AllotTitle " + where;
        ...
        /// <returns></returns>
        public DataSet GetSdl_AllotTitlePageData(string pageNum, int PageSize, string where)
        {
            string sql = "select top 10000000000 * from Sdl_AllotTitle " + where + "  order by timeflag desc ";
            return SQLServerHelper.Query(PageSqlHelper.GetCanPageSql(pageNum, PageSize, sql));
        }

        public DataSet GetSdl_AllotTitleSetByField(string[] fieldNames, string where)
        {
            string fields = "";
            ...
            string sql = "select " + fields + " from Sdl_AllotTitle " + where;
            return SQLServerHelper.Query(sql);
        }
        ...
        /// 是否存在该记录
        /// </summary>
        public bool ExistsSdl_AllotTitle(string timeFlag, string ebeln)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from Sdl_AllotTitle ");
        ...
        /// 是否存在该记录
        /// </summary>
        public bool ExistsSdl_AllotTitle(string timeFlag, string ebeln, string trucknum)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from Sdl_AllotTitle ");
        ...
        /// 增加一条数据
        /// </summary>
        public int AddSdl_AllotTitle(Sdl_AllotTitle model)
        {
            if (!ExistsSdl_AllotTitle(model.TIMEFLAG, model.EBELN))
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("insert into Sdl_AllotTitle(");
                strSql.Append("TRUCKNUM,EBELN,TIMEFLAG,ENTERTIME,EXITTIME,HSFLAG,TARE,");
                strSql.Append("GROSS,RESWK,ENTERWEIGHMAN,DEDUCTNUM,EXITWEIGHMAN,EXITFLAG,ALLOTFLAG,WERKS,TRAYWEIGHT,TRAYNUM)");
                strSql.Append(" values (@trucknum,@ebeln,@timeflag,@entertime,@exittime,@hsflag,@tare,");
                strSql.Append("@gross,@reswk,@enterweighman,@deductnum,@exitweighman,@exitflag,@allotflag,@werks,@trayweight,@traynum)");
                SqlParameter[] parameters = {
					new SqlParameter("@trucknum", SqlDbType.NVarChar,20),
					new SqlParameter("@ebeln", SqlDbType.NVarChar,20),
                ...
                parameters[14].Value = model.WERKS;
        ...
        /// 更新一条数据
        /// </summary>
        public void UpdateSdl_AllotTitle(Sdl_AllotTitle model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Sdl_AllotTitle set ");
        ...
        /// 更新一条数据
        /// </summary>
        public void UpdateSdl_AllotTitle(Sdl_AllotTitle model, string ebeln, string truckNum)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Sdl_AllotTitle set ");
            strSql.Append("trucknum=@trucknum,");
            ...
            parameters[16].Value = model.WERKS;
            SQLServerHelper.ExecuteSql(strSql.ToString(), parameters);
        }
        ...
        /// 更新一条数据
        /// </summary>
        public void UpdateSdl_AllotTitleByTimeFlag(Sdl_AllotTitle model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Sdl_AllotTitle set ");
            strSql.Append("trucknum=@trucknum,");
        ...
        /// <returns></returns>
        public int AmendSdl_AllotTitle(string timeFlag, string ebeln, string columnName, Object value)
        {
            string sequel = "Update [Sdl_AllotTitle] set ";
        ...
        /// 删除一条数据
        /// </summary>
        public void DeleteSdl_AllotTitle(string timeFlag, string ebeln)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Sdl_AllotTitle ");
            strSql.Append(" where timeflag=@timeflag and ebeln=@ebeln");
            SqlParameter[] parameters = {
				new SqlParameter("@timeflag", SqlDbType.NVarChar,30),
                new SqlParameter("@ebeln", SqlDbType.NVarChar,20)};
        ...
        /// 删除一条数据
        /// </summary>
        public void DeleteSdl_AllotTitle(string timeFlag, string ebeln, string truckNum)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Sdl_AllotTitle ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Sdl_AllotTitle GetSdl_AllotTitle(string truckNum, string ebeln, string timeFlag)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 TRUCKNUM,ebeln,ENTERWEIGHMAN,TARE,TIMEFLAG,ENTERTIME,EXITTIME,HSFLAG,GROSS,RESWK,DEDUCTNUM,EXITWEIGHMAN,EXITFLAG,ALLOTFLAG,WERKS,TRAYWEIGHT,TRAYNUM from Sdl_AllotTitle ");
            ...
            {
                return GetSdl_AllotTitleRow(ds.Tables[0].Rows[0]);
            }
            else
            {
                return null;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Sdl_AllotTitle GetSdl_AllotTitle(string truckNum, string timeFlag)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 TRUCKNUM,EBELN,ENTERWEIGHMAN,TARE,TIMEFLAG,ENTERTIME,EXITTIME,HSFLAG,GROSS,RESWK,DEDUCTNUM,EXITWEIGHMAN,EXITFLAG,ALLOTFLAG,WERKS,TRAYWEIGHT,TRAYNUM from Sdl_AllotTitle ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Sdl_AllotTitle GetSdl_AllotTitle(string timeFlag)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 TRUCKNUM,EBELN,ENTERWEIGHMAN,TARE,TIMEFLAG,ENTERTIME,EXITTIME,HSFLAG,GROSS,RESWK,DEDUCTNUM,EXITWEIGHMAN,EXITFLAG,ALLOTFLAG,WERKS,TRAYWEIGHT,TRAYNUM from Sdl_AllotTitle ");
            strSql.Append(" where timeflag=@timeflag ");
        ...
        /// <param name="timeFlag"></param>
        /// <returns></returns>
        public DataTable GetSdl_AllotTitleDataTable(string truckNum, string timeFlag)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ebeln from Sdl_AllotTitle ");
            strSql.Append("where timeflag=@timeflag and truckNum=@truckNum");
            SqlParameter[] parameters = 
            { 
                new SqlParameter("@timeflag", SqlDbType.NVarChar,30),
        ...
        /// <returns></returns>
        public List<Sdl_AllotTitle> GetSdl_AllotTitleList(System.Data.DataTable table)
        {
            List<Sdl_AllotTitle> list = new List<Sdl_AllotTitle>();
            for (int i = 0; i < table.Rows.Count; i++)
            {
                list.Add(GetSdl_AllotTitleRow(table.Rows[i]));
            }
            return list;
        }
        ...
        /// <returns></returns>
        private Sdl_AllotTitle GetSdl_AllotTitleRow(System.Data.DataRow row)
        {

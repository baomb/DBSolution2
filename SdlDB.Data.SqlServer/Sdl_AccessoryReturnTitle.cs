...
namespace SdlDB.Data.SqlServer
{
    public partial class DataProvider : IDataProvider
    {
        ...
        public DataSet GetSdl_AccessoryReturnTitleSet(string where)
        {
            string sql = "select * from Sdl_AccessoryReturnTitle " + where;
        ...
        /// <returns></returns>
        public DataSet GetSdl_AccessoryReturnTitlePageData(string pageNum, int PageSize, string where)
        {
            string sql = "select top 10000000000 * from Sdl_AccessoryReturnTitle " + where + "  order by timeflag desc ";
            return SQLServerHelper.Query(PageSqlHelper.GetCanPageSql(pageNum, PageSize, sql));
        }

        public DataSet GetSdl_AccessoryReturnTitleSetByField(string[] fieldNames, string where)
        {
            string fields = "";
            ...
            string sql = "select " + fields + " from Sdl_AccessoryReturnTitle " + where;
            return SQLServerHelper.Query(sql);
        }
        ...
        /// 是否存在该记录
        /// </summary>
        public bool ExistsSdl_AccessoryReturnTitle(string timeFlag, string ebeln)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from Sdl_AccessoryReturnTitle ");
        ...
        /// 是否存在该记录
        /// </summary>
        public bool ExistsSdl_AccessoryReturnTitle(string timeFlag, string ebeln, string trucknum)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from Sdl_AccessoryReturnTitle ");
        ...
        /// 增加一条数据
        /// </summary>
        public int AddSdl_AccessoryReturnTitle(Sdl_AccessoryReturnTitle model)
        {
            if (!ExistsSdl_AccessoryReturnTitle(model.TIMEFLAG, model.EBELN))
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("insert into Sdl_AccessoryReturnTitle(");
        ...
        /// 更新一条数据
        /// </summary>
        public void UpdateSdl_AccessoryReturnTitle(Sdl_AccessoryReturnTitle model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Sdl_AccessoryReturnTitle set ");
        ...
        /// 更新一条数据
        /// </summary>
        public void UpdateSdl_AccessoryReturnTitle(Sdl_AccessoryReturnTitle model, string ebeln, string truckNum)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Sdl_AccessoryReturnTitle set ");
            strSql.Append("trucknum=@trucknum,");
        ...
        /// 更新一条数据
        /// </summary>
        public void UpdateSdl_AccessoryReturnTitleByTimeFlag(Sdl_AccessoryReturnTitle model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Sdl_AccessoryReturnTitle set ");
            strSql.Append("trucknum=@trucknum,");
        ...
        /// <returns></returns>
        public int AmendSdl_AccessoryReturnTitle(string timeFlag, string ebeln, string columnName, Object value)
        {
            string sequel = "Update [Sdl_AccessoryReturnTitle] set ";
        ...
        /// 删除一条数据
        /// </summary>
        public void DeleteSdl_AccessoryReturnTitle(string timeFlag, string ebeln)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Sdl_AccessoryReturnTitle ");
            strSql.Append(" where timeflag=@timeflag and ebeln=@ebeln");
            SqlParameter[] parameters = {
				new SqlParameter("@timeflag", SqlDbType.NVarChar,30),
                new SqlParameter("@ebeln", SqlDbType.NVarChar,20)};
        ...
        /// 删除一条数据
        /// </summary>
        public void DeleteSdl_AccessoryReturnTitle(string timeFlag, string ebeln, string trucknum)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Sdl_AccessoryReturnTitle ");
            strSql.Append(" where timeflag=@timeflag and ebeln=@ebeln and trucknum=@trucknum");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Sdl_AccessoryReturnTitle GetSdl_AccessoryReturnTitle(string truckNum, string ebeln, string timeFlag)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 TRUCKNUM,ebeln,ENTERWEIGHMAN,TARE,TIMEFLAG,ENTERTIME,EXITTIME,HSFLAG,GROSS,WERKS,EXITWEIGHMAN,DEDUCTNUM,EXITFLAG,DBNUM from Sdl_AccessoryReturnTitle ");
            ...
            {
                return GetSdl_AccessoryReturnTitleRow(ds.Tables[0].Rows[0]);
            }
            else
            {
                return null;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Sdl_AccessoryReturnTitle GetSdl_AccessoryReturnTitle(string truckNum, string timeFlag)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 TRUCKNUM,ebeln,ENTERWEIGHMAN,TARE,TIMEFLAG,ENTERTIME,EXITTIME,HSFLAG,GROSS,WERKS,EXITWEIGHMAN,DEDUCTNUM,EXITFLAG,DBNUM from Sdl_AccessoryReturnTitle ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Sdl_AccessoryReturnTitle GetSdl_AccessoryReturnTitle(string timeFlag)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 TRUCKNUM,ebeln,ENTERWEIGHMAN,TARE,TIMEFLAG,ENTERTIME,EXITTIME,HSFLAG,GROSS,WERKS,EXITWEIGHMAN,DEDUCTNUM,EXITFLAG,DBNUM from Sdl_AccessoryReturnTitle ");
            strSql.Append(" where timeflag=@timeflag ");
        ...
        /// <returns></returns>
        public List<Sdl_AccessoryReturnTitle> GetSdl_AccessoryReturnTitleList(System.Data.DataTable table)
        {
            List<Sdl_AccessoryReturnTitle> list = new List<Sdl_AccessoryReturnTitle>();
            for (int i = 0; i < table.Rows.Count; i++)
            {
                list.Add(GetSdl_AccessoryReturnTitleRow(table.Rows[i]));
            }
            return list;
        }
        ...
        /// <returns></returns>
        private Sdl_AccessoryReturnTitle GetSdl_AccessoryReturnTitleRow(System.Data.DataRow row)
        {

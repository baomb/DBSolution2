...
namespace SdlDB.Data.SqlServer
{
    ...
    {
        #region  Sdl_FinishedProductsExchangeInTitle

        public DataSet GetSdl_FinishedProductsExchangeInTitleDataSet(string where)
        {
            string sql = "select * from sdl_FinishedProductsExchangeInTittle " + where;
        ...
        /// <returns></returns>
        public DataSet GetSdl_FinishedProductsExchangeInTitlePageData(string pageNum, int PageSize, string where)
        {
            string sql = "select top 10000000000 * from sdl_FinishedProductsExchangeInTittle " + where + "  order by timeflag desc ";
            string sql2 = PageSqlHelper.GetCanPageSql(pageNum, PageSize, sql);
            return SQLServerHelper.Query(sql2);
        }

        public DataSet GetSdl_FinishedProductsExchangeInTitleDataSetByField(string[] fieldNames, string where)
        {
            string fields = "";
            ...
            string sql = "select " + fields + " from sdl_FinishedProductsExchangeInTittle " + where;
            return SQLServerHelper.Query(sql);
        }
        ...
        /// 是否存在该记录
        /// </summary>
        public bool ExistsSdl_FinishedProductsExchangeInTitle(string timeFlag, string oanum, string truckNum)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from sdl_FinishedProductsExchangeInTittle ");
        ...
        /// 增加一条数据
        /// </summary>
        public int AddSdl_FinishedProductsExchangeInTitle(Sdl_FinishedProductsExchangeTitle model)
        {
            try
            {
                StringBuilder strSql = new StringBuilder();
                strSql.Append("insert into sdl_FinishedProductsExchangeInTittle(");
        ...
        /// 更新一条数据
        /// </summary>
        public void UpdateSdl_FinishedProductsExchangeInTitle(Sdl_FinishedProductsExchangeTitle model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update sdl_FinishedProductsExchangeInTittle set ");
            ...
            SqlParameter[] parameters = {
                ...
                new SqlParameter("@xsqy", SqlDbType.NVarChar,30),
                new SqlParameter("@xsks", SqlDbType.NVarChar,30),
                new SqlParameter("@isout", SqlDbType.NVarChar,2)
            };
            ...
            parameters[21].Value = model.ISOUT;
            SQLServerHelper.ExecuteSql(strSql.ToString(), parameters);
        }
        ...
        /// 更新一条数据
        /// </summary>
        public void UpdateSdl_FinishedProductsExchangeInTitleByTimeFlag(Sdl_FinishedProductsExchangeTitle model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update sdl_FinishedProductsExchangeInTittle set ");
            strSql.Append("TRUCKNUM=@trucknum,");
        ...
        /// 更新一条数据
        /// </summary>
        public void UpdateSdl_FinishedProductsExchangeInTitle(Sdl_FinishedProductsExchangeTitle model, string truckNum, string oanum)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update sdl_FinishedProductsExchangeInTittle set ");
            strSql.Append("TRUCKNUM=@trucknum,");
            ...
            parameters[24].Value = model.ISOUT;
            SQLServerHelper.ExecuteSql(strSql.ToString(), parameters);
        }
        ...
        /// 得到一个对象实体
        /// </summary>
        public Sdl_FinishedProductsExchangeTitle GetSdl_FinishedProductsExchangeInTitle(string truckNum, string oanum, string timeFlag)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 * from sdl_FinishedProductsExchangeInTittle ");
            ...
            {
                return GetSdl_FinishedProductsExchangeInTitleRow(ds.Tables[0].Rows[0]);
            }
            else
            {
                return null;
        ...
        /// 删除一条数据
        /// </summary>
        public void DeleteSdl_FinishedProductsExchangeInTitle(string timeFlag, string oanum, string truckNum)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from sdl_FinishedProductsExchangeInTittle ");
        ...
        /// <returns></returns>
        public List<Sdl_FinishedProductsExchangeTitle> GetSdl_FinishedProductsExchangeInTitleList(System.Data.DataTable table)
        {
            List<Sdl_FinishedProductsExchangeTitle> list = new List<Sdl_FinishedProductsExchangeTitle>();
            for (int i = 0; i < table.Rows.Count; i++)
            {
                list.Add(GetSdl_FinishedProductsExchangeInTitleRow(table.Rows[i]));
            }
            return list;
        }
        ...
        /// <returns></returns>
        private Sdl_FinishedProductsExchangeTitle GetSdl_FinishedProductsExchangeInTitleRow(System.Data.DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                model.ISOUT = row["ISOUT"].ToString();

...
namespace SdlDB.Utility
{
    public class DataSetHelper
    {
        ...
        /// <returns></returns>
        public DataTable GetNewDataTable(DataTable dt, string condition, string sortstr)
        {
            ...
            {
                //newdt.Rows.Add(dr[i].ItemArray);//加入 
        ...
        /// <param name="condition">查询条件</param>
        /// <returns></returns>
        public DataTable GetNewSortDataTable(DataTable dt, string condition, string sortstr)
        {
            DataTable newdt = new DataTable();
            newdt = dt.Clone();
